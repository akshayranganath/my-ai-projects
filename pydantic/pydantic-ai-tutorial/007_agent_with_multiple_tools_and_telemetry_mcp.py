...
agent = Agent(
    ...
    If the user asks for temperature in degree celcius, use the tool provided to convert the temperature.
    
    User Playwright when user asks you to browser or interact with a web page.""",
    capabilities=[
