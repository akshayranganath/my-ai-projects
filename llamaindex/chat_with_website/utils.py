...
def load_data_from_url(url: str, bedrock_obj:MyBedrockObject, show_progress:bool=True) -> bool:
...
def load_data_from_pdf(pdf, bedrock_obj:MyBedrockObject, show_progress:bool=True) -> bool:
